...
export default function ListDeviceOff() {
  ...
  return (
    <div>
      ...
      <div className="layout-content-header">
        <h3 className="search-dash-name">Danh sách thiết bị không hoạt động</h3>
      ...
      <div className="search-filter-dash-header">
        ...
        <TableDevice endpoint="/device/listDeviceNoActive"  getListDelete={() => getListDelete()} listOff={true}/>
      </div>
    </div>
  );
}
